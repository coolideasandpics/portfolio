...
const LiquidGradientBackground = () => {
  ...
  useEffect(() => {
    ...
    const colors = [
      ...
      "#C51D1D", // deep red
      "#F15300", // hot orange
      "#5A0F12", // burgundy instead of dark green-black
      "#D9B64C", // mustard
      "#8C1D18", // red-brown instead of navy
    ];
    ...
    const uniforms = {
      ...
      uColor1: { value: hexToVector3(colors[0]) },
      uColor2: { value: hexToVector3(colors[1]) },
      uColor3: { value: hexToVector3(colors[2]) },
      uColor4: { value: hexToVector3(colors[3]) },
      uColor5: { value: hexToVector3(colors[4]) },
      uColor6: { value: hexToVector3(colors[5]) },
    ...
    geometry = new THREE.PlaneGeometry(viewSize.width, viewSize.height, 1, 1);
  ...
  return <div ref={containerRef} className="liquid-gradient-background" />;
};
